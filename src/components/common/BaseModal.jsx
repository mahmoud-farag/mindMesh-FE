...
export default function BaseModal({
    ...
    const defaultCancelClasses = 'bg-slate-100 hover:bg-slate-300 text-slate-700 px-5 py-2 rounded-lg font-medium cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed';
    const defaultConfirmClasses = 'bg-violet-500 hover:bg-violet-600 text-white px-5 py-2 rounded-lg font-medium cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    return (
        ...
        >
            <div
                className={`relative w-full bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-6 transition-all duration-300 ease-out ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-20 opacity-0'
