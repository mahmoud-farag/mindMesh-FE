...
flashCardsService.getFlashcardForDocument = async (
  params = {},
  options = {}
) => {
  try {
    ...
    const response = await axiosClient.get(
      FLASHCARDS_PATHS.GET_FLASHCARDS_FOR_DOC(documentId)
    );
    ...
    throw (
      error.response?.data ?? {
        message: 'Error while fetching document flashcards',
      }
    );
  }
};
...
flashCardsService.reviewFlashCard = async (params = {}, options = {}) => {
  try {
    ...
    const response = await axiosClient.post(
      FLASHCARDS_PATHS.REVIEW_FLASHCARD(cardId)
    );

    return response.data;
  } catch (error) {
    throw (
      error.response?.data ?? { message: 'Error while reviewing the flashcard' }
    );
  }
};
...
flashCardsService.deleteFlashCardSet = async (params = {}, options = {}) => {
  try {
    ...
    const response = await axiosClient.delete(
      FLASHCARDS_PATHS.DELETE_FLASHCARD_SET(flashCardSetId)
    );

    return response.data;
  } catch (error) {
    throw (
      error.response?.data ?? { message: 'Error while deleting flashcard set' }
    );
  }
};
...
flashCardsService.toggleFlashCard = async (params = {}, options = {}) => {
  try {
    ...
    const response = await axiosClient.patch(
      FLASHCARDS_PATHS.TOGGLE_STAR(cardId)
    );

    return response.data;
  } catch (error) {
    throw (
      error.response?.data ?? { message: 'Error while toggling the flashcard' }
    );
  }
};
