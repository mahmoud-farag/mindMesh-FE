...
quizService.getQuizzesForDocument = async (params = {} ) => {
  try {
    ...
    throw error.response?.data ?? { message: 'Error while getting document quizzes' };
  }
};
...
quizService.getQuizById = async (params = {}, options = {}) => {
  try {
    ...
    throw error.response?.data ?? { message: 'Error while fetching quiz details' };
  }
};
...
quizService.getQuizResults = async (params = {}, options = {}) => {
  try {
    ...
    throw error.response?.data ?? { message: 'Error while fetching quiz results' };
  }
};
...
quizService.submitQuiz = async (params = {}, options = {}) => {
  try {
    ...
    const response = await axiosClient.post(QUIZZES_PATHS.SUBMIT_QUIZ(quizId), { answers } );

    return response.data;

  } catch(error) {

    throw error.response?.data ?? { message: 'Error while submitting the quiz answers' };
  }
};
